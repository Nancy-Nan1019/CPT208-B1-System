...
This folder records the main English prompts used during AI-assisted work for the OpenMind Discussion Platform.

The prompts are grouped by task area:

- `01-ui-redesign-prompts.md`: visual redesign and design-system prompts
- `02-gamification-prompts.md`: playful discussion room and interaction prompts
- `03-avatar-and-rejoin-prompts.md`: avatar logic, consistency, leaderboard, and rejoin flow prompts
